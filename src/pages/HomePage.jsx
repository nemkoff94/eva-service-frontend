      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Надежный эвакуатор в Обнинске 24/7. Быстрая подача, безопасная транспортировка, работа с любыми расстояниями. Вызов эвакуатора онлайн или по телефону занимает всего 30 секунд!
          </p>
              ...
              <div className="flex items-center justify-center">
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700 italic">
                    "Быстро приехали, аккуратно погрузили. Цена соответствовала озвученной. Рекомендую всем — лучший эвакуатор в Обнинске!"
                  </p>
